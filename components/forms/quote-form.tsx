  ...
  if (submitted) {
    return (
      <div className="rounded-2xl bg-surface-panel border border-accent/40 p-8 md:p-14 text-center shadow-gold-lg">
        ...
        <p className="text-fg-strong/80 max-w-lg mx-auto leading-relaxed text-sm sm:text-base">
      ...
      <div className="min-h-[420px]">
            ...
            <div>
              ...
              <label className="block mt-5">
                ...
                <input
                  ...
                  placeholder="V2Y 1A1"
                  maxLength={7}
                  className="mt-1 w-full px-4 py-3 rounded-xl bg-surface-elevated/80 border border-divider-strong text-fg-strong placeholder:text-fg-muted/60 focus-visible:border-accent focus-visible:outline-none"
                />
              </label>
            </div>
          </div>
        ...
        {step === 2 && (
          <div className="space-y-6">
            ...
            <div className="rounded-xl bg-surface-elevated/60 border border-divider-strong p-4 sm:p-5">
              <p className="font-display text-base sm:text-lg font-bold text-fg-strong mb-1.5">
                Have photos?
              </p>

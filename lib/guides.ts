...
export const guides: Guide[] = [
  {
    ...
    body: [
      ...
      {
        type: "callout",
        title: "Get a written drywall estimate within 24 hours",
        text: "Submit photos and a description of every patch through the quote form at summit-handyman.ca/quote. Brody reviews scope, texture, and access before replying in writing with a real number, usually the same day. The $150 minimum applies to the visit, not per patch, so bundling related repairs into one trip is the most cost-effective way to handle a list.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        text: "The other hidden cost is the list itself. One small repair feels DIY-able. A backlog of eight repairs feels like a renovation, and it never actually gets handled. Bundling those eight items into a single Brody visit usually costs less than a couple of weekends of Home Depot trips, and the work is finished by Tuesday instead of accumulating into year three.",
      },
      {
        type: "callout",
        title: "Bundle the 'hire it out' list",
        text: "If you have two or more items from the 'hire it out' column above, send them all to Brody at once. The $150 minimum applies to the visit, not each item, so a bundled list is dramatically better value than booking one-off fixes. Submit photos through the quote form at summit-handyman.ca/quote and Brody replies in writing within 24 hours.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      { type: "h2", text: "When to handle it yourself versus call" },
      {
        type: "p",
        text: "Most of this checklist is genuinely DIY-friendly: hose disconnection, battery swaps, ceiling fan reversal, attic insulation check. The items where homeowners most often book Brody are exterior caulking (wet weather closes the cure window fast), weather stripping replacement on stubborn doors, deck and railing tightening, and the small carpentry items that compound if ignored. Those are the calls worth making before October, not after.",
      },
      {
        type: "callout",
        title: "Bundle the fall list",
        text: "Most of these items are most efficiently handled in one visit before the rain settles in. The $150 minimum applies to the visit, not each item, so the bundled list is dramatically cheaper than scheduling individual fixes through October. Submit photos through the quote form at summit-handyman.ca/quote and Brody replies within 24 hours with a written estimate.",
      },
    ],
  },
  {
    ...
    excerpt:
      "How Summit Handyman works with property managers across the Lower Mainland on turnovers, tenant requests, access notes, and detailed invoicing that satisfies strata accounting.",
    date: "2026-02-22",
    readingMinutes: 6,
    ...
    body: [
      {
        type: "p",
        text: "The two patterns that wreck property-management workflows in the Lower Mainland are the same ones every manager knows: contractors who do not pick up the phone, and invoices that arrive without enough detail to satisfy strata accounting. The first costs you days. The second costs you the back-and-forth that delays every other property on your portfolio.",
      },
      {
        type: "p",
      ...
      { type: "h2", text: "How invoicing works (and why it matters)" },
      {
        type: "p",
        text: "Every Summit Handyman invoice for property managers comes itemized: labor by category, materials at cost with a small handling fee, and GST broken out separately. That structure is what lets strata accounting reconcile the charge against the line item in their budget without coming back to you for clarification. When photo documentation is requested, the photos reference the line items so the strata council sees exactly what was done where.",
      },
      {
        type: "p",
        text: "The practical effect is that most property-management invoices from Summit Handyman are approved on first review. That matters more than it sounds: every back-and-forth with strata accounting is a delayed payable on Brody's side and a delayed close-out on the manager's side. Getting the invoice format right the first time is one of the smallest things a handyman can do that has the biggest workflow impact.",
      },
      { type: "h2", text: "The standard workflow on a tenant turnover" },
      {
        type: "p",
        text: "Most turnovers follow a predictable rhythm: scope email from the manager, photos and access notes shared back, written estimate from Brody within 24 hours, work scheduled to the move-out date or sooner, before/after photos uploaded, itemized invoice issued same day as completion. Brody's role is making each of those steps boringly reliable. The manager's role is sending the scope clearly the first time, which the quote form happens to enforce well.",
      },
      {
        type: "callout",
        title: "What sets repeat property work apart",
        text: "After two or three jobs, Brody knows the building, the access rules, the invoicing preferences, and the ways the previous tenant tends to leave the unit. That institutional memory means quotes get faster, scope discussions get shorter, and the manager spends less time explaining context every time. The repeat-work value compounds.",
      },
      {
        type: "callout",
  ...
  },
  {
    ...
    excerpt:
      "Small repairs that quietly protect the house before moisture, movement, or wear compounds into a much larger invoice. The order to handle them in, plus how to spot trouble early.",
    date: "2026-03-08",
    readingMinutes: 6,
    hero: "/images/guide-small-repairs.webp",
    body: [
      ...
      {
        type: "p",
        text: "This applies equally to concrete walkways, garage floor cracks, and any exterior masonry where water can get in. The maintenance product is inexpensive and the application is straightforward, but the timing window matters: dry weather for a couple of days before and after, ideally above 10 degrees Celsius. Late spring and early fall are the windows in BC.",
      },
      {
        type: "callout",
        title: "The compounding rule",
        text: "Every small repair on this list, ignored for one BC winter, is a meaningfully larger repair the next year. Ignored for two winters, it is often a different category of repair entirely. The cost of catching them early is so much lower than the cost of letting them compound that it almost always justifies a single bundled visit.",
      },
      {
        type: "callout",
        title: "Bundle the small stuff",
        text: "If you have two or three of these on the list, bundle them into one Summit Handyman visit. The $150 minimum applies to the visit, not each item, so a bundled list is dramatically better value than booking individual fixes. Submit photos through the quote form at summit-handyman.ca/quote and Brody replies in writing within 24 hours.",
      },
    ],
  },
  {
    ...
    body: [
      {
        type: "p",
        text: "Smart-home shopping is overwhelming on purpose. Every device promises to change your life, every brand has six tiers, and the marketing photography always shows a perfectly lit minimalist house that looks nothing like a real BC home. After installing hundreds of these devices across Langley, Surrey, White Rock, Aldergrove, Abbotsford, and Cloverdale, the pattern becomes obvious: a few categories of smart device are genuinely useful, several are a waste of money for most households, and the install details (not the device) usually decide whether the upgrade lasts.",
      },
      {
        type: "p",
        text: "This guide is the short version of what Brody recommends to homeowners across the Lower Mainland: what to install first, what to skip, and the install details that separate a smart-home upgrade that lasts from one that becomes a battery-replacement chore.",
      },
      { type: "h2", text: "Worth installing first" },
      {
        type: "p",
        text: "These are the devices with the highest hit rate. In hundreds of installs, almost no homeowner has ever regretted them, and several have specifically called out daily routines that got better.",
      },
      {
        type: "ul",
        items: [
      ...
      { type: "h2", text: "Skip or wait on these" },
      {
        type: "p",
        text: "These are the devices that sound great in the showroom but consistently disappoint in real BC homes. Not bad products, just bad fits for most households compared to the alternatives above.",
      },
      {
        type: "ul",
        items: [
      ...
      {
        type: "callout",
        title: "The two questions that decide every smart-home purchase",
        text: "First: does it improve a daily routine, not a once-in-a-while moment? Second: will it still work in five years (firmware support, battery economics, app maintenance)? If the answer to both is yes, install it. If either is no, the device is solving a problem that does not exist in your house.",
      },
      { type: "h2", text: "The install details that decide whether it lasts" },
      {
        type: "p",
        text: "Smart-home devices fail more often from install issues than from device defects. The four most common failure points are predictable: wiring (especially the C-wire question on smart thermostats), strike-plate alignment on smart locks, network coverage in the corner of the house where the camera lives, and battery management on devices that use AAs in cold BC weather. Brody confirms each of these on the install rather than discovering them later.",
      },
      {
        type: "callout",
        title: "Permitting note",
        text: "Many smart-device installs stay within homeowner-allowed scope, such as swapping an existing fixture for a same-power fixture or replacing a thermostat that has compatible wiring. Anything that requires new wiring runs, panel changes, or permits goes to a licensed electrician. Brody refers out when needed and only quotes the work that legitimately falls in handyman scope.",
      },
      { type: "h2", text: "How to phase in a smart home" },
      {
        type: "p",
        text: "Most homeowners start with a single device and grow from there. The order Brody recommends, based on hit rate and ease of integration, is: video doorbell first (highest daily impact), then smart deadbolt (changes household workflow), then smart thermostat (quiet ROI on BC heating bills), then smart switches at the four or five locations that matter most. Hardwired smoke and CO detectors slot in whenever the existing units are due for replacement (every 10 years).",
      },
      {
        type: "callout",
        title: "Get a smart-home install quoted",
        text: "Submit photos of the install location plus the device you are considering (or want a recommendation for) through the quote form at summit-handyman.ca/quote. Brody confirms compatibility, flags any wiring or permitting issues, and replies in writing within 24 hours with a single estimate that includes app pairing and a walk-through.",
      },
    ],
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        text: "If your deck faces south or west, choose a UV-resistant stain. The summer sun on a Surrey or White Rock deck will fade a regular semi-transparent quickly. Sansin and Behr Premium both have UV-stable lines worth the upcharge on exposed decks.",
      },
      { type: "h2", text: "When to call instead of DIY" },
      {
        type: "p",
        text: "A confident homeowner with a weekend and a pressure washer can absolutely refinish a small ground-level deck. The calls usually come for second-storey decks (ladder time and safety), decks with significant rotted boards (the rot needs proper diagnosis before any finish goes down), or decks where the homeowner has tried once and the result was disappointing. The cost of getting it right the first time, with proper prep and material selection, is almost always less than the cost of stripping a failed DIY job and starting over.",
      },
      {
        type: "callout",
        title: "Get a written deck-refinishing estimate",
        text: "Send photos of every angle of the deck through the quote form at summit-handyman.ca/quote, plus rough dimensions and any visible damage or rotted boards. Brody replies in writing within 24 hours with a real number, a working timeline, and the recommended stain for your specific exposure. The $150 minimum applies to the visit, not each section.",
      },
    ],
  },

...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        // Fluid typography (clamp-based). Letter-spacing intentionally not too tight,
        // and minimums tuned so display text never overflows narrow viewports.
        "display-2xl": ["clamp(2.25rem, 7.5vw, 6.5rem)", { lineHeight: "1.02", letterSpacing: "-0.02em" }],
        "display-xl": ["clamp(1.875rem, 5.75vw, 5rem)", { lineHeight: "1.05", letterSpacing: "-0.015em" }],
        "display-lg": ["clamp(1.625rem, 4.75vw, 3.75rem)", { lineHeight: "1.1", letterSpacing: "-0.012em" }],
        "display-md": ["clamp(1.5rem, 3.5vw, 2.75rem)", { lineHeight: "1.15", letterSpacing: "-0.01em" }],
        "display-sm": ["clamp(1.25rem, 2.5vw, 2rem)", { lineHeight: "1.2", letterSpacing: "-0.005em" }],
      },
      letterSpacing: {
        tightest: "-0.04em",
        tighter: "-0.025em",

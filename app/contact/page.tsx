          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {channels.map((c) => (
              <Reveal key={c.label}>
                ...
                >
                  <div className="h-12 w-12 rounded-xl bg-accent-soft border border-accent/20 flex items-center justify-center mb-5 group-hover:bg-accent-soft transition-colors">
                  ...
                  {c.badge && (
                    <p className="mt-4 inline-block text-[10px] sm:text-[11px] uppercase tracking-wider px-2.5 py-1 rounded-full bg-accent-soft text-accent font-semibold">
                      {c.badge}
                    </p>
                  )}
                </a>

      ...
      <Section size="lg">
        <Container>
          ...
          <Reveal className="mt-12">
            <div className="rounded-2xl bg-gradient-to-br from-summit-panel via-summit-panel to-summit-gold/5 border border-summit-gold/30 p-8 md:p-10 text-center">
              <p className="text-xs uppercase tracking-[0.18em] text-summit-gold font-semibold mb-3">
                Need a written quote?
              </p>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-summit-mist mb-3 text-balance">
                Use the multi-step quote form for the fastest turnaround.
              </h2>
              <p className="text-summit-mist/80 max-w-xl mx-auto mb-6">
      ...
      <Section size="md" className="bg-summit-panel/40 border-y border-summit-slate/40">
        <Container>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-7 rounded-2xl bg-summit-panel border border-summit-slate/60">
              <Clock className="h-7 w-7 text-summit-gold mb-4" strokeWidth={1.5} />
              <h3 className="font-display text-xl font-bold text-summit-mist mb-3">Hours</h3>
              <p className="text-summit-mist/80 leading-relaxed">{site.hours}</p>
              <p className="mt-2 text-sm text-summit-stone">
                Email checked throughout the day. Most quotes returned within 24 hours.
              </p>
            </div>
            <div className="p-7 rounded-2xl bg-summit-panel border border-summit-slate/60">
              <MapPin className="h-7 w-7 text-summit-gold mb-4" strokeWidth={1.5} />
              <h3 className="font-display text-xl font-bold text-summit-mist mb-3">
                Service areas
              </h3>
              <p className="text-summit-mist/80 leading-relaxed">

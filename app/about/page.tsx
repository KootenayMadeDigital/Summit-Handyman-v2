          ...
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            <Reveal className="lg:col-span-5">
              <div className="lg:sticky lg:top-32 space-y-6">
                ...
                <div className="rounded-2xl bg-summit-panel border border-summit-slate/60 p-6">
                  ...
                  <p className="text-sm text-summit-stone mt-1">Langley, BC</p>
                  <div className="mt-5 flex flex-col gap-3">
                    <a
                      href={`mailto:${site.contact.email}`}
                      className="flex items-center gap-2 text-sm text-summit-mist hover:text-summit-gold transition-colors"
                    >
                      <Mail className="h-4 w-4 text-summit-gold" />
                      {site.contact.email}
                    </a>
                    <a
            ...
            <Reveal className="lg:col-span-7 space-y-8" delay={0.1}>
              <p className="font-serif text-2xl md:text-3xl leading-snug text-summit-mist text-pretty text-balance">
                "{site.about}"
              </p>

              <div className="space-y-6 text-summit-mist/85 leading-relaxed text-lg">
                <p>
                ...
                <p>
                  ...
                  <span className="text-summit-gold font-semibold italic font-serif">
                    "{site.promise}"
                  </span>{" "}
              ...
              <div className="pt-6 border-t border-summit-slate/40">
                <p className="text-xs uppercase tracking-[0.18em] text-summit-gold font-semibold mb-6">
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  {principles.map((p) => (
                    <div
                      key={p.title}
                      className="p-5 rounded-xl bg-summit-panel border border-summit-slate/60"
                    >
                      <h3 className="font-display text-lg font-bold text-summit-mist mb-2">
                        {p.title}
                      </h3>

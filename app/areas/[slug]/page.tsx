...
const cityProfiles: Record<string, CityProfile> = {
  ...
  "white-rock": {
    ...
    texture: "Around East Beach, West Beach, Marine Drive, and the hillside neighbourhoods, small repairs often overlap with exterior upkeep, weathered finishes, railings, gutters, decks, and detail work that needs to look clean when finished.",
    ...
    commonJobs: ["Exterior maintenance and touch-ups", "Gutter, deck, and fence upkeep", "Interior repair lists", "Fixture, hardware, and safety upgrades"],
  ...
  aldergrove: {
    ...
    texture: "Around Aldergrove Town Centre, Otter District, and County Line, the work often leans toward exterior upkeep, doors, fences, decks, gutters, pressure washing, and interior repair lists for busy households.",
    ...
    commonJobs: ["Fence, deck, and gate repairs", "Gutter maintenance and pressure washing", "Door, trim, and hardware fixes", "Interior repairs and painting prep"],
